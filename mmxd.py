...
try:
	prox= requests.get('https://github.com/arohi999/napa/blob/main/Approval.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/arohi999/napa/blob/main/Approval.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/arohi999/napa/blob/main/Approval.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('napa1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    os.system("clear");print(logo)
    print(f" Your Key : \x1b[1;31m"+Xyteee)
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get('https://github.com/arohi999/napa/blob/main/Approval.txt').text
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : NAPA Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
